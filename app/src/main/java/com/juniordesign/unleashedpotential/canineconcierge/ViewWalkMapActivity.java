...
public class ViewWalkMapActivity extends AppCompatActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_walk_map);
...
//        }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        database.getReference("map_walks").child(mapWalkID).addValueEventListener(new ValueEventListener() {
            boolean zoom = true;
            @Override
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(ViewWalkMapActivity.this,
